       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Afficher la fréquentation des étudiants</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Afficher la fréquentation des étudiants</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Afficher la fréquentation des étudiants</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">Selectionner étudiant<span class="text-danger ml-2">*</span></label>
                        <?php
                        ...
                        <label class="form-control-label">Type<span class="text-danger ml-2">*</span></label>
                          ...
                          <option value="2" >Par date unique</option>
                          <option value="3" >Par plage de dates</option>
                        </select>
                        </div>
                    </div>
                      <?php
                    ...
                    <button type="submit" name="view" class="btn btn-primary">Afficher la participation</button>
                  </form>
                </div>
              </div>
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">La présence en classe</h6>
                </div>
